...
DataStore.prototype.upsert = function (testObj) {
    ...
    if (o.length > 0) {
        return this.update(testObj);
    } else {
        return this.insert(testObj);
    }
...
/**
 * Updates existing db item
 * @param testObj
 * @returns the passed object
 */
DataStore.prototype.update = function (testObj) {
 ...
 * @returns the passed object
 */
DataStore.prototype.insert = function (testObj) {
